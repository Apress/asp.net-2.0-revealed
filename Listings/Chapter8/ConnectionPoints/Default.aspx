...
<asp:content id="Content1" contentplaceholderid="ContentPlaceHolder1" runat="server">
    ...
    <asp:webpartmanager runat="server" id="WebPartManager">
        <connections>
            <asp:connection consumerid="WeatherWebPart1" providerid="ZipProviderWebPart1" enabled="true" providername="ZipProviderPoint" consumername="ZipConsumerPoint"></asp:connection>
        </connections>   
    </asp:webpartmanager>
        ...
        <tr>
            <td valign="top">
                <asp:webpartzone id="WPZ_LeftZone" runat="server" width="100%" draghighlightcolor="244, 198, 96" title="Left Zone">
                    ...
                    <zonetemplate>
                        <webparts:ZipProviderWebPart id="ZipProviderWebPart1" runat="server" />
